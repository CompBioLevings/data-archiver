...
data_fastq='all-data-fastq.txt'
external_data_fastq='external-data-fastq.txt'
combined_fastq='all-fastq-archive-list.txt'
ignore_files='ignored-files.txt'
archive_mapping='archived-mapping.txt'
...
python ~/pipeline/archiver/find_files.py data "$search_regex" -e "$exclude_regex" -o "$data_fastq"
python ~/pipeline/archiver/find_files.py external_data "$search_regex" -e "$exclude_regex" -o "$external_data_fastq"
...
python ~/pipeline/filter_new_files.py -i "$combined_fastq" -g "$igore_files" -a "$archive_mapping" -o "$filtered_fastq"
...
python ~/pipeline/archiver/archive_organizer.py "$filtered_fastq" -o new-fastq-archive-mapping.txt